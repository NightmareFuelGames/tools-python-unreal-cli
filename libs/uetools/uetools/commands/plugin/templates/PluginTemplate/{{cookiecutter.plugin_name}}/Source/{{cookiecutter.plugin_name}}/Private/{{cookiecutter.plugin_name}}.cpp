...
#define LOCTEXT_NAMESPACE "F{{cookiecutter.plugin_name}}Module"
...
void F{{cookiecutter.plugin_name}}Module::StartupModule()
{
    EnsureShaderPathIsConfigured();
}

void F{{cookiecutter.plugin_name}}Module::ShutdownModule()
{
...
IMPLEMENT_MODULE(F{{cookiecutter.plugin_name}}Module, {{cookiecutter.plugin_name}})