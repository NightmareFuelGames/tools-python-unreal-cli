#!/usr/bin/env python
"""
uetools documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "uetools"))
...
man_pages = [(master_doc, "uetools", "uetools Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "uetools",
        "uetools Documentation",
        author,
        "uetools",
        uetools.core.__descr__,
        "Miscellaneous",
    ),
]
